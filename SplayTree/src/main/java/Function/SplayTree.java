...
public class SplayTree {
    ...
    public void insertWithoutSplaying(int ele) {
        SplayNode z = root;
        SplayNode p = null;
        while (z != null) {
            p = z;
     ...
     * function splay
     **/
    private long Splay(SplayNode x) {
        long startfTime = System.nanoTime();
        while (x.parent != null) {
